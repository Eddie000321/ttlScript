  ...
  <body>
    ...
    <header>
      <div class="brand">
        ...
        <span>Networking Lab Assistant (Offline)</span>
      </div>
        ...
        <div class="recovery-cards">
          ...
          <div style="margin-bottom:12px;padding:12px;background:rgba(139,92,246,0.1);border-radius:8px;border:1px solid rgba(139,92,246,0.2);">
            ...
            <div style="color:#94a3b8;font-size:0.75em;margin-top:6px;">
              <strong>Auto-Enter:</strong> Sends Enter every 500ms.
            </div>
          </div>
          ...
          <!-- Router Reset for Password: prompt Card -->
          <div class="card" onclick="toggleCard(this)">
            <div class="card-header">
              <div class="card-title">
                ...
                <span>Router Reset for Password:</span>
              </div>
            </div>
            <div class="card-body">
              <div style="padding:10px 0;color:#94a3b8;font-size:0.85em;">
                <strong style="color:#f59e0b;">▶ Click when you see "Password:" prompt</strong>
              </div>
              <div style="padding:5px 0;color:#94a3b8;font-size:0.85em;">
                <strong>Password Test:</strong>
                <span class="code-snippet">cisco</span> →
                <span class="code-snippet">class</span>
              </div>
              <div style="padding:5px 0 10px 0;color:#94a3b8;font-size:0.85em;">
                <strong>Steps:</strong>
          ...
          <!-- Router Reset for No Password Card (> → en → wr er → reload) -->
          <div class="card" onclick="toggleCard(this)">
            <div class="card-header">
              <div class="card-title">
                <span style="display:inline-block;width:14px;height:14px;border-radius:3px;background:#1a1a1a;border:1px solid #22c55e;margin-right:6px;"></span>
                <span>Router Reset for No Password</span>
              </div>
            </div>
            <div class="card-body">
              <div style="padding:10px 0;color:#94a3b8;font-size:0.85em;">
                <strong style="color:#22c55e;">▶ Click when you see "Router>" prompt</strong>
              </div>
              <div style="padding:5px 0;color:#94a3b8;font-size:0.85em;">
                <strong>No password required</strong> (enable secret not set)
              </div>
              <div style="padding:5px 0 10px 0;color:#94a3b8;font-size:0.85em;">
                <strong>Steps:</strong>
                <span class="code-snippet">en</span> →
                <span class="code-snippet">wr er</span> →
                <span class="code-snippet">reload</span>
              </div>
              <div id="progressRouterQuickV2" class="progress-bar" style="display:none;">
                <div class="progress-step" data-step="1"></div>
                <div class="progress-step" data-step="2"></div>
                <div class="progress-step" data-step="3"></div>
                <span class="progress-label">Ready</span>
              ...
              <button
                id="btnRouterQuickV2"
                class="btn-run"
                onclick="runRouterQuickResetV2(event)"
                disabled
              >
                <span>Run Script</span>
              </button>
          ...
          <div class="card" onclick="toggleCard(this)">
            <div class="card-header">
               <div class="card-title">
                ...
                <span>Switch Reset for Password:</span>
              </div>
            </div>
            <div class="card-body">
              <div style="padding:10px 0;color:#94a3b8;font-size:0.85em;">
              ...
              <div id="progressSwitchQuickPass" class="progress-bar" style="display:none;">
                <div class="progress-step" data-step="1"></div>
                <div class="progress-step" data-step="2"></div>
                <div class="progress-step" data-step="3"></div>
              ...
              <button
                id="btnSwitchQuickPass"
                class="btn-run"
                onclick="runSwitchQuickResetPass(event)"
                disabled
              >
                <span>Run Script</span>
              </button>
          ...
          <!-- Switch Reset for No Password -->
          <div class="card" onclick="toggleCard(this)">
            <div class="card-header">
              <div class="card-title">
                <span style="display:inline-block;width:14px;height:14px;border-radius:3px;background:#f0f0f0;border:1px solid #999;margin-right:6px;"></span>
                <span>Switch Reset for No Password</span>
              </div>
            </div>
            <div class="card-body">
              <div style="padding:10px 0;color:#94a3b8;font-size:0.85em;">
                <strong style="color:#22c55e;">▶ Click when you see "Switch>" prompt</strong>
              </div>
              <div style="padding:0 0 10px 0;color:#94a3b8;font-size:0.85em;">
                <strong>Steps:</strong>
                <span class="code-snippet">en</span> →
              ...
              <div id="progressSwitchQuickNoPass" class="progress-bar" style="display:none;">
                <div class="progress-step" data-step="1"></div>
                <div class="progress-step" data-step="2"></div>
                <div class="progress-step" data-step="3"></div>
                <div class="progress-step" data-step="4"></div>
              ...
              <button
                id="btnSwitchQuickNoPass"
                class="btn-run"
                onclick="runSwitchQuickResetNoPass(event)"
                disabled
              >
                <span>Run Script</span>
              </button>
          ...
          <div class="card" onclick="toggleCard(this)">
            <div class="card-header">
              <div class="card-title">
                <span style="display:inline-block;width:14px;height:14px;border-radius:3px;background:#1a1a1a;border:1px solid #444;margin-right:6px;"></span>
                <span>Router Recovery (Auto)</span>
                <span class="tag">ISR / ASR</span>
              </div>
            </div>
            <div class="card-body">
              <div style="padding:10px 0;color:#94a3b8;font-size:0.85em;">
                <strong style="color:#22c55e;">▶ Use this first (Reloads Router)</strong>
              </div>
              <ul class="steps-list">
                <li>Script sends <strong>reload</strong> command.</li>
                <li>Auto-sends <strong>Break signals</strong> until ROMMON.</li>
                <li>Restores config automatically.</li>
              </ul>
              <button
                id="btnRouter"
                class="btn-run"
                onclick="runRouterRecoveryAuto(event)"
                disabled
              >
                <span>Run Script</span>
              </button>
          ...
          <!-- Router Recovery (Manual) -->
          <div class="card" onclick="toggleCard(this)">
            <div class="card-header">
              <div class="card-title">
                <span style="display:inline-block;width:14px;height:14px;border-radius:3px;background:#ef4444;border:1px solid #991b1b;margin-right:6px;"></span>
                <span>Router Recovery (Manual)</span>
                <span class="tag">Fallback</span>
              </div>
            </div>
            <div class="card-body">
              <div style="padding:10px 0;color:#94a3b8;font-size:0.85em;">
                <strong style="color:#ef4444;">▶ Use if Auto fails (Power Cycle)</strong>
              </div>
              <ul class="steps-list">
                <li>Turn <strong>OFF</strong> → Turn <strong>ON</strong>.</li>
                <li>Click button immediately.</li>
                <li>Script auto-sends Break until <span class="code-snippet">rommon 1 ></span>.</li>
              </ul>
              <button
                id="btnRouterManual"
                class="btn-run"
                onclick="runRouterRecoveryManual(event)"
                disabled
              >
                <span>Run Script</span>
              </button>
          ...
          <div class="card" onclick="toggleCard(this)">
            <div class="card-header">
              <div class="card-title">
                ...
                <span>9200 Recovery - Phase 1 (Boot)</span>
                <span class="tag">Catalyst 9200/9300</span>
              </div>
            </div>
            <div class="card-body">
              <div style="padding:10px 0;color:#94a3b8;font-size:0.85em;">
                <strong style="color:#f59e0b;">▶ Click when you see "switch:" prompt</strong>
              </div>
              <ul class="steps-list">
                <li>
                  Unplug power. Hold
                ...
                <li>This sets IGNORE_STARTUP_CFG and boots.</li>
              </ul>
              <button
                id="btn9200Boot"
                class="btn-run"
                onclick="run9200Boot(event)"
                disabled
              >
                <span>Run Script</span>
              </button>
          ...
          <!-- 9200 Recovery - Phase 2: Reset -->
          <div class="card" onclick="toggleCard(this)">
            <div class="card-header">
              <div class="card-title">
                <span style="display:inline-block;width:14px;height:14px;border-radius:3px;background:#22c55e;border:1px solid #16a34a;margin-right:6px;"></span>
                <span>9200 Recovery - Phase 2 (Reset)</span>
              </div>
            </div>
            <div class="card-body">
              <div style="padding:10px 0;color:#94a3b8;font-size:0.85em;">
              ...
              <div style="padding:5px 0 10px 0;color:#94a3b8;font-size:0.85em;">
                ...
                <span class="code-snippet">enable</span> →
                <span class="code-snippet">write erase</span> →
                <span class="code-snippet">no system ignore...</span> →
                <span class="code-snippet">reload</span>
              </div>
              <button
                id="btn9200Reset"
                class="btn-run"
                onclick="run9200Reset(event)"
                disabled
              >
                <span>Run Script</span>
              </button>
    ...
    <footer style="background:rgba(30,41,59,0.8); backdrop-filter:blur(12px); border-top:1px solid var(--border-color); padding:12px 24px; text-align:center; color:#94a3b8; font-size:0.8rem;">
      <p style="margin-bottom:6px;">
        xterm.js has been converted to Python and included in this offline version.<br>
        For parts using xterm.js, we adhere to its license terms.<br>
        This is a personal test version, not intended for commercial use.
      </p>
      <p style="margin:0;">
        Created by <strong style="color:var(--primary-color);">Jaehyeok Lee</strong><br>
        <span style="font-size:0.9em;opacity:0.8;">Special thanks to <strong>Leo Laurencio</strong>, <strong>Nhat Quang Nguyen</strong> for their advice.</span>
      </p>
    </footer>
